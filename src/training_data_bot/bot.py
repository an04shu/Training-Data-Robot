...
This module contains the core TrainingDataBot class that orchestrates all
functionality including document loading, processing, quality assessment,
and dataset export.
"""
...
from .ai import AIClient  # For AI text generation
...
class TrainingDataBot:
    ...
    def _init_components(self):
        ...
        try:
            # Initialize Decodo client first (shared across components)
            self.decodo_client = DecodoClient()
            
            # Core components (pass shared Decodo client to UnifiedLoader)
            self.loader = UnifiedLoader(decodo_client=self.decodo_client)
            self.ai_client = AIClient()  # For AI text generation
        ...
        **kwargs
        ...
        with LogContext("document_processing"):
            try:
                ...
                for doc in documents:
                    # Preprocess document (chunking, cleaning)
                            ...
                            try:
                                ...
                                if quality_filter:
                                    ...
                                    if quality_report.passed:
                                        ...
                                        self.logger.debug(f"Example filtered due to quality: {quality_report.issues}")
                                else:
                                    all_examples.append(example)
    ...
    async def export_dataset(
        ...
        **kwargs
        ...
        Args:
            ...
            split_data: Whether to create train/val/test splits
    ...
    async def cleanup(self):
        ...
        try:
            ...
            # AI client cleanup (if it has cleanup methods)
